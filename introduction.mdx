...
- Minimize external dependencies: This enhances code maintainability and simplifies long-term changes. It's the way to go. Our dependencies are so few that we will list them:
