...
- **Docker**: A preconfigured **Docker Compose** setup with corresponding **Dockerfiles** for each service, including optional **Grafana + Loki + Prometheus Monitoring** stack.
