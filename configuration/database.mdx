...
There are two settings for PostgreSQL, local and remote. Local one with set up a docker postgres on your machine. The remote will require a database connection parameters:
