...
The OAuth implementation does not depend on any external libraries. It's built using the `golang.org/x/oauth2` library. The main loginc can be found in the `/auth/provider.go` file.
